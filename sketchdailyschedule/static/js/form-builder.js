$(document).ready(function(){
  ...
  var genSource = function(){
    ...
    jason = new Object();
    fieldlist = new Array();
    jason.name = $($temptxt).find("legend").text();

    $($temptxt).find(".control-group").each(function(index){
      field = new Object();
      fieldoptions = new Array();
      field.name = $(this).find(".control-label").text();
      
      if($(this).find("input").attr('type')){
                field.field_type = $(this).find("input").attr('type');
      }
      else{
    ...
    jason.fields = fieldlist;
    $("#json").val(JSON.stringify(jason));
    $("#jsonsource").val(JSON.stringify(jason));
    $("#formtitle").val($($temptxt).find("legend").text());
  }
  ...
  $("#target").delegate(".component", "click", function(e){
    ...
    $(".popover").delegate(".btn-inverse", "click", function(e){
      e.preventDefault();
      $active_component.detach();
      $active_component.popover("hide");
    });
