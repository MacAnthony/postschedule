...
class Command(BaseCommand):
	...
	r = praw.Reddit(user_agent='Sketchdaily Schedule Bot 1.0 by /u/davidwinters github.com/davidwinters/postschedule')
        ...
        r.submit('sketchdailyCanada', thetitle, thetext)
	...
	if not np:
	    r.send_message('/r/sketchdailycanada', 'no theme scheduled for tomorrow', 'please schedule a theme for tomorrow at http://themes.sketchdaily.net')
        log.info('Theme Posted by %s \n' % REDDIT_USER)
